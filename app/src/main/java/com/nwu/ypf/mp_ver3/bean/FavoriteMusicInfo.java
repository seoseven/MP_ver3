...
public class FavoriteMusicInfo implements IMusicInfo {

    @PrimaryKey
    private long id = -1;

    /**
     * 添加时间，使用 {@link System#currentTimeMillis()} 赋值。
     */
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FavoriteMusicInfo)) return false;
        FavoriteMusicInfo musicInfo = (FavoriteMusicInfo) o;
        return getId() == musicInfo.getId() &&
                ...
                getAddTime() == musicInfo.getAddTime() &&
    ...
    public FavoriteMusicInfo(@NonNull String musicName, @NonNull Uri uri) {
        this.musicName = musicName;
        this.uri = uri;
    }

    public FavoriteMusicInfo(IMusicInfo musicInfo) {
